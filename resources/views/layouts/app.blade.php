    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard.index') }}">
                ...
                <div class="sidebar-brand-text mx-3">ePraga</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    </ul> <!--fim navbar-nav ml-auto -->
                </nav> <!-- fim navbar navbar-expand navbar -->
            ...
            <footer class="sticky-footer bg-white">
                ...
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; ePraga {{ Date('Y') }}</span>
                </div>
                </div>
            </footer>
            <!-- End of Footer -->

        </div> <!-- fim div content-wrapper -->
    </div> <!-- fim div wrapper -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Confirmar encerramento da sessão.</div>
