              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">ePraga</h1>
                  </div>
                  <form class="user" method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="form-group">
                      <input type="number" class="form-control form-control-user" name="cpf_cnpj" aria-describedby="emailHelp" placeholder="Informe seu CPF">
                    </div>
                    <div class="form-group">
